...
<body>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="#">Entri Transaksi Order</a></li>
                        <li class="nav-label">Components Data</li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="#">Data History Order</a></li>
                    </li>
                </ul>
            </div>
        </div>
    ...
    ***********************************-->
    ...
    <script src="/assests/plugins/tables/js/datatable-init/datatable-basic.min.js"></script>
